...
이 그림에서 눈여겨볼 곳은 왼쪽 아래의 화살표다. 자료가 들어오는 것만으로는 위키가 자라지 않는다. 새 자료가 기존 생각을 강화하는지, 적용 범위를 좁히는지, 아니면 틀렸다고 드러내는지를 판단해 종합 문서에 반영할 때 비로소 지식이 축적된다. 이 판단을 건너뛰면 문서 수만 늘고 다음 질문에 답하는 능력은 그대로다. 좋은 LLM-Wiki는 새 질문과 작업을 더 정확하게 이어 주는 위키다. 판단 기준은 단순하다. 지금 이 위키에 새 질문을 던졌을 때, 반년 전의 나와 지금의 내가 같은 출발점에 서는가. 그렇다면 위키가 일하고 있는 것이고, 다른 출발점에 선다면 문서가 쌓이기만 한 것이다.
...
성공 기준은 세 주제 중 최소 하나에서 사라진 것이 판단이나 맥락이었다는 점을 스스로 확인하는 것이다. 사실은 다시 찾을 수 있지만 판단과 맥락은 다시 만들어야 하고, 그것이 이 책 전체가 다루는 문제다.

# 흔한 오해

첫째, 폴더 구조를 잘 짜면 지식이 축적된다고 생각하는 것이다. 구조는 필요조건까지만 채워 준다. 잘 나눈 폴더에 정리되지 않은 파일을 넣으면 잘 나뉜 채로 흩어진다. 축적을 만드는 것은 문서 사이의 연결과 갱신이다. 둘째, AI가 자료를 넣기만 하면 알아서 이해하고 정확하게 정리한다고 기대하는 것이다. AI는 형식을 맞추고 후보를 제안하는 일에 강하지만, 두 논문의 결과가 왜 다른지 같은 판단에서는 그럴듯한 설명을 만들어 낼 수 있다. 그 설명이 맞는지 확인하는 일은 사람이 원자료로 돌아가야 한다. 셋째, 처음부터 완벽한 분류 체계를 만들어야 한다고 생각하는 것이다. 분류는 무엇을 다시 찾을지에 따라 정해지는데, 그것은 자료가 어느 정도 쌓여야 알 수 있다. 다섯 편으로 시작해 분류가 불편해지는 지점에서 고치는 편이 낫다. 넷째, 도구를 정하는 일이 가장 중요하다고 보는 것이다. 이 책이 다루는 것은 자료와 해석을 분리하고 연결을 유지하는 작업 방식이다. 도구는 바뀌지만 이 방식은 남는다.
...
지금은 폴더도 도구도 정하지 않았다. 정할 것은 무엇을 기억할지이고, 그것을 정한 사람만이 다음 장에서 만들 폴더를 자기 것으로 쓸 수 있다. AI와 나눈 좋은 대화가 사라지는 이유는 기억이 놓일 자리가 없기 때문이다. 자리를 만드는 일이 이 책의 처음이자 끝이고, 그 자리는 폴더 하나와 문서 몇 개로 시작한다.
