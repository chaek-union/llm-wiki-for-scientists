...
part: 3
budget: 18000
evidence: [E-014, E-120, E-121, E-150, E-151, E-153, E-154, E-155, E-156, E-157, E-200, E-201, E-202, E-203, E-204, E-210, E-211, E-212, E-213, E-214, E-215, E-216, E-217, E-220, E-221, E-222, E-224, E-230, E-231, E-232, E-233, E-234, E-235, E-237, E-240, E-241, E-242, E-243, E-244, E-245, D-001, D-002]
---

# 12장. 학생과 연구자를 지도하는 법

오후에 세 사람과 차례로 면담이 잡혀 있다고 하자. 첫 번째는 공개 데이터 재분석으로 방법을 익히는 학부 연구생 1년차이고, 두 번째는 첫 주저자 원고를 준비하는 대학원 3년차이며, 세 번째는 독립 과제를 준비하면서 후배도 지도하는 박사후연구원이다. 세 사람이 지금 붙들고 있는 문제는 서로 겹치지 않는다. 앞 면담에서 다음 면담으로 넘어가는 사이에 머릿속의 맥락을 통째로 갈아 끼워야 하고, 갈아 끼우는 데 실패하면 면담의 앞부분은 지난번에 무엇을 합의했는지 되묻는 데 쓰이고, 되묻는 시간이 길어질수록 오늘 내려야 할 결정은 다음으로 밀린다. 사람에 관한 기록을 한곳에 모으면 이 문제가 풀릴 것 같지만 실제 운영은 반대로 갔다. 학위와 행정 서류의 파일 위치와 처리 상태를 담는 작업 공간이 하나 있고, 연구 주제와 담당과 역량과 멘토링 판단은 문헌 위키의 registry가 소유한다. 성격이 다른 두 축을 왜 갈랐고 가른 뒤에 어떻게 다시 잇는지가 이 장이 가르칠 것이다. 세 사람은 합성 사례다. 여러 연구실에서 반복해서 나타나는 상황을 합쳐 만들었고, 이 장에서는 이름 대신 S1, S2, S3으로 부른다. 사람에 관한 기록을 다루는 장에서 실제 인물의 조합을 쓰면 식별 정보를 지워도 당사자는 알아본다. 시스템의 구조와 반복되는 원칙은 실제 운영에서 가져오되 사람과 기관에 관한 것은 합성한다는 규칙을 파트 3 전체에 적용한다.
...
세 번째 단계가 지도의 질을 가른다. 원고가 부족하다는 말은 다음에 무엇을 해야 할지 정해 주지 않는다. 두 번째 그림의 결과가 서론의 중심 주장을 직접 지지하지 않으므로 주장을 좁히거나 분석을 하나 더한다는 말은 다음 행동을 정한다. 피드백을 근거와 논리로 나누면 어느 쪽이 부족한지가 드러나는데, 근거가 부족하면 분석을 더하고 논리가 부족하면 주장을 고친다. S2의 다음 확인 지점은 주장과 증거를 대응시킨 지도의 초안인데, 11장에서 다룬 대응 관계를 원고 단위로 적어 두면 세 번째 단계가 훨씬 빨라진다. 두 번째 단계를 건너뛰면 한 판에서 모든 것을 고치려 하게 되고, 주장과 그림과 분석을 한꺼번에 손대면 무엇 때문에 나아졌는지 알 수 없다. 고정된 범위 밖에서 발견한 문제는 그 자리에서 고치지 않고 열린 항목으로 적어 두는데, 적어 두지 않으면 다음 판에서 새로 발견된 것처럼 다시 나온다. 같은 지적이 반복되는 원인 중 상당수가 여기에 있다.

원고를 소유한 작업 공간은 원고의 정본이고 사람에 관한 정본이 아니다. 그 공간이 학생 지도와 닿는 지점은 두 개뿐인데, 다음 사람이 이어받을 수 있는 형태로 넘기라는 인계 문서 규칙과 원고 로그에 남는 확인 항목이다. 대신 그 공간은 판본을 다루는 규칙을 촘촘하게 갖는다. 받은 원본은 작업 단위 폴더 안의 원본 자리에 두고 덮어쓰지 않으며 파생본은 새 이름으로 만든다. 지금 제출하는 판본은 작업 폴더의 루트에 두고 초안 폴더 아래에 숨기지 않으며, 새 판본이 나오면 직전 판본을 같은 레벨의 지난 판본 자리로 밀어내고, 중간 산출물은 그 아래나 작업 공간 밖의 임시 자리로 보낸다. 규칙이 이렇게 촘촘한 이유는 되돌리기 수단이 동기화 서비스의 버전 기록뿐이기 때문이다. 이 전제가 규칙 전체를 지배해서, 덮어쓰기 전에 먼저 읽고 무엇을 바꿀지 보이고 승인을 받는 순서가 모든 작업 공간에서 같다. 학생이 보낸 판본을 열어 그 자리에서 고쳐 저장하는 습관은 이 순서를 통째로 건너뛴다.
...
사람에 관한 기록은 만들기 전에 두 가지를 정한다. 누가 읽을 수 있는가와 언제 지우는가. 두 가지를 정하지 않은 기록은 시간이 지나면 지울 수 없게 되는데, 왜 만들었는지 잊히면 지워도 되는지 판단할 근거도 함께 사라지기 때문이다. 기록의 목적은 성장 지원과 작업 연속성이고, 목적에 필요하지 않은 정보는 처음부터 넣지 않는다. 건강, 가족, 심리 상태에 관한 정보는 연구 수행을 설명하는 근거로 쓰지 않는다. 진행이 늦은 이유를 개인적 사정으로 추정해 적으면 추정이 사실처럼 남고, 당사자가 그 기록을 볼 수 없는 상태에서 계속 인용된다. 사정을 알게 되는 일 자체는 피할 수 없지만, 알게 된 것을 지도 기록에 축적하는 일은 선택이다. 기록에는 합의된 일정 조정처럼 작업에 관한 사실만 남긴다. 심리 상태에 대한 판단은 지도교수의 전문 영역이 아니고, 문서로 남기는 순간 전문가의 판단처럼 읽힌다.
...
5. 아직 닫히지 않은 확인 항목을 나열하고 각각에 확인됨, 불일치, 미확인, 보류, 재실행 필요 중 하나를 붙인다.
6. 다음 면담의 목적을 한 문장으로 쓰고 확인 가능한 다음 지점을 하나 정한 뒤, 문서를 다시 읽으며 확인 시점이 오래된 항목에 재검토 필요 표시를 붙인다.
...
첫째, 사람에 관한 기록을 한곳에 모으면 관리가 쉬워진다고 보는 것이다. 연락처와 현재 담당과 잠정적 해석은 갱신 주기도 접근 범위도 보존 기간도 다르고, 한 문서에 모으면 가장 엄격한 규칙이 전부에 적용되거나 가장 느슨한 규칙이 전부에 적용된다. 실제 운영이 학위 서류의 처리 상태와 연구 지도의 판단을 다른 곳에 둔 이유가 여기에 있다. 둘째, 기록이 많을수록 지도가 좋아진다고 보는 것이다. 면담 녹취와 메일 사본을 모두 남기면 다음 면담 전에 무엇을 읽어야 할지 판단하는 데 시간이 더 들고, 결국 아무것도 읽지 않게 된다. 남길 것을 정하는 규칙이 없으면 기록은 늘어나면서 동시에 쓸모없어진다. 셋째, 에이전트가 만든 인물 요약을 현재 상태로 받아들이는 것이다. 요약은 그 시점에 읽은 문서들의 함수이고, owner 문서가 갱신되지 않았다면 낡은 상태를 매끄러운 문장으로 다시 말할 뿐이다.

넷째, 축을 정했으니 축마다 점수를 매길 수 있다고 생각하는 것이다. 축을 나눈 목적은 지금 어느 축에 발판이 필요한지를 고르는 데 있고, 점수를 붙이는 순간 축은 비교와 순위의 도구가 된다. 사람 사이의 비교는 지도의 다음 행동을 정해 주지 않으면서 기록에는 오래 남는다. 다섯째, 내부 기록을 그대로 보여주는 것이 투명한 지도라고 보는 것이다. 잠정적 해석은 갱신을 전제로 쓰인 문장이고, 그 전제를 모르는 사람이 읽으면 판정으로 읽힌다. 투명해야 하는 것은 다음에 무엇을 보고 판단할 것인가다. 여섯째, 한 사람에게 통한 개입을 곧바로 규칙으로 올리는 것이다. 승격 조건에 같은 혼선의 반복이 들어 있는 이유는 한 번의 성공이 그 사람의 상황에서만 성립할 수 있기 때문이고, 확인 없이 올린 규칙은 나머지 사람에게 맞지 않는 요구가 되어 돌아온다.

# 내 위키에 남기기

- 한 사람분의 현재 상태 기록을 만들고, 각 항목이 어느 owner에 속하는지 표시한다. 다른 owner의 소유인 항목은 값을 복제하지 말고 어디를 보면 되는지만 적는다.
- 관찰, 해석, 지도 행동, 다음 확인 지점의 네 칸 형식과 다섯 개의 상태 라벨을 별도 문서로 저장한다. 다음 면담부터 이 형식으로 한 줄씩 추가한다.
- 사람에 관한 기록에 넣지 않을 항목의 목록을 짧게 적어 작업 공간의 지침 파일에 넣는다. 그 목록에 항목을 추가할 때 지켜야 할 승격 조건도 한 줄로 함께 적는다.

지도에서 남는 산출물은 근거가 갱신되는 사람별 기록이다. 근거가 갱신되지 않는 기록은 시간이 지나면 인상이 되고, 인상은 확인할 방법이 없다.
