...
아래 블록은 AI 도구의 채팅창에 그대로 붙여 넣는 프롬프트다. 저는 먼저 만들고 싶은 결과를 말하고, 그다음에 참고할 방법과 방향을 적는다. 채널 구조를 만들고 싶다는 목적을 먼저 알려 주면 뒤에 이어지는 문장들이 작업 조건으로 읽힌다.

```text
내가 개인 workspace에 자동화 산출물을 받을 채널 구조를 만들고 싶어.
아래 방법과 방향을 참고해서 만들어줘.
