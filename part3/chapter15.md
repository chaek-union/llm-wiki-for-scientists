...
```text
1. 진행 중이거나 준비 중인 과제 하나를 고른다
   (이미 제출한 과제여도 좋고 아직 공고를 검토하는 단계여도 좋다)
