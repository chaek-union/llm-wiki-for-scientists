...
이 구분을 흐리는 상황이 몇 가지 있다. 파일을 올리지 않고 내용만 붙여 넣으면 괜찮다고 생각하는 경우가 첫째인데, 전송되는 것은 같다. 기관이 계약한 서비스라면 괜찮다고 보는 경우가 둘째다. 기관 계약은 그 서비스와 기관 사이의 문제이고, 특정 연구의 심의 조건과는 별개다. 자료를 조금 가공했으니 원본이 아니라고 보는 경우가 셋째다. 가공의 정도가 재식별 가능성을 실제로 없앴는지가 기준이고, 열 이름만 바꾼 표는 여전히 원본이다. 판단이 애매하면 넣지 않는 쪽을 고른다. 넣지 않아서 잃는 것은 그 작업의 편의이고, 넣어서 잃는 것은 되돌릴 수 없다.
