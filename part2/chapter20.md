...
파트 2는 여기서 닫힌다. 16장에서 분야의 지도를 그리고, 18장에서 남의 방법을 자기 설계로 바꾸고, 19장에서 다른 사람과 판단을 맞추고, 20장에서 자신의 근거로 주장을 쓰는 것이 연구를 시작하는 사람이 지나는 순서다. 네 장을 관통하는 문장은 하나다. 좋은 논문을 쓰는 능력은 중요한 질문을 알아보고, 결정적인 근거를 설계하고, 다른 사람과 판단을 맞추며, 그 판단의 책임을 지는 능력에서 시작한다. 영어 문장을 다듬는 기술은 그 능력이 자리를 잡은 뒤에 얹힌다. 네 장에서 만든 산출물도 서로 이어져 있어서, field map이 서론의 재료가 되고 method page가 한계 서술의 재료가 되며 결정 기록이 결론 강도의 근거가 된다. 하나만 만들어 두면 나머지 셋이 비어 있는 자리를 그대로 드러낸다. 파트 2를 지나는 동안 다룬 논문은 파트 1에서 따라온 여섯 편에 18장의 벤치마킹 논문 한 편을 더한 것이고, 그 밖에 새로 들인 논문은 없다.

파트 3은 같은 구조를 여러 사람이 함께 쓰는 상황으로 옮긴다. 학생마다 필요한 것이 다르고, 공동연구자마다 볼 수 있는 자료의 범위가 다르며, 그랜트와 행정 서류에는 위키 밖으로 나가면 안 되는 정보가 섞인다. 혼자 쓰는 위키에서는 판단이 하나뿐이라 정본을 정할 일이 없지만, 같은 문서를 두 사람이 다르게 고치면 어느 쪽이 정본인지 정해야 한다. 공개할 수 있는 지식과 그렇지 않은 기록을 같은 층에 두면 언젠가 잘못 나가고, 잘못 나간 뒤에 되돌릴 방법은 없다. 이 장에서 만든 claim-evidence 지도도 여러 사람이 함께 쓰면 성격이 달라져서, 누가 어느 주장의 근거를 책임지는지가 표의 한 칸으로 들어온다. 그랜트 문서는 같은 주장을 다른 독자에게 다른 강도로 말하는 산출물이고, 어느 강도까지 허용되는지는 이 장에서 만든 지도가 정한다. 기관이 배포한 행정 양식은 서식을 바꾸면 반려되므로 내용의 자유도가 가장 낮다. 혼자 쓰던 위키를 둘이 쓰기 시작하는 첫 자리는 대체로 새 사람이 들어올 때이고, 그 자리에서 무엇을 건네고 무엇을 남기는지를 21장에서 다룬다.
