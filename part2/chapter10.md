...
미팅이 결정을 남기는 자리가 되는 것은 미팅장에서 정해지지 않는다. 무엇을 결정할지 미리 적고, 그 결정에 필요한 근거만 골라 하루 전에 건네고, 결정과 책임자와 다음 조건을 그날 안에 적어 두는 일에서 정해진다.
