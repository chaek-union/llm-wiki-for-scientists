...
사람이 깊이 읽을 논문은 자기 연구의 축에 닿는 몇 편이면 된다. 6장에서 ingest에 등급을 두지 않는다고 한 것은 문서의 품질 기준을 나누지 않는다는 뜻이고 사람이 그 논문을 얼마나 깊이 이해할지는 별개다. 대부분의 논문은 무엇을 했고 어디에 놓이는지를 아는 것으로 충분하다. 어느 논문에 원문까지 내려가 시간을 들일지는 대체로 두 번째로 열게 될 때 드러난다. 한 번 넣고 다시 열지 않는 논문과 자꾸 되돌아가는 논문이 갈리고 뒤쪽이 시간을 들일 대상이다.
