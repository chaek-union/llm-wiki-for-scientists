...
# 21장. 에이전트가 대신해 주지 않는 것

파트 2의 여섯 장은 논문을 읽는 데서 시작해 주장을 쓰고 새 사람에게 건네는 데까지 왔다. 마지막으로 짚을 것이 하나 남는다. 이 도구가 무엇을 대신해 주고 무엇을 대신해 주지 않는가다. 학생이 자주 하는 오해가 하나 있고, 지도하는 쪽에서 자주 하는 피드백도 같은 자리에 있다. 논문을 위키에 넣고 요약을 받으면 그 내용을 안다고 느끼는 상태가 되는데, 그 느낌과 실제로 아는 것 사이의 거리가 생각보다 멀다. 이 거리를 좁히는 일은 여전히 사람이 시간을 들여야 하고, 도구가 좋아진다고 줄어들지 않는다. 이 장은 그 거리에 대한 이야기다. 무엇이 자동화되고 무엇이 자동화되지 않는지, 그리고 자동화되지 않는 쪽을 어떻게 훈련하는지를 다룬다. 파트 2가 다룬 기법은 이 전제 위에서만 값이 있다. 전제가 없으면 산출물은 늘어나고 실력은 그대로인 상태가 된다. 파트 3으로 넘어가기 전에 이 장을 두는 이유도 같다. 사람을 지도하는 자리에서 이 구분이 흐려지면 그 흐림이 그대로 전달되기 때문이다.
...
지도교수가 바쁘다면 연구실 동료와 하면 된다. 같은 주제를 파는 사람이 아니어도 되고, 오히려 다른 주제를 하는 사람에게 설명할 때 더 많이 드러난다. 그 사람이 배경을 모르므로 어디서부터 설명해야 하는지를 자기가 정해야 하고, 그 정하는 작업이 자기 이해의 구조를 드러낸다. 실행 방법은 간단하다. 논문 한 편을 넣고 정리한 뒤에 그 내용을 십 분 동안 누군가에게 설명하는 자리를 만든다. 매주 한 번이면 충분하고, 정해 두지 않으면 하지 않게 된다. 16장에서 다루는 미팅 준비도 같은 훈련의 연장선이다. 무엇을 결정해 달라고 요청할지 정하고 그 근거를 골라 내는 일이 곧 자기 이해를 정리하는 일이기 때문이다.
