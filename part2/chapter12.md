...
파트 2는 여기서 닫힌다. 9장에서 분야의 지도를 그리고, 10장에서 남의 방법을 자기 설계로 바꾸고, 11장에서 다른 사람과 판단을 맞추고, 12장에서 자신의 근거로 주장을 쓰는 것이 연구를 시작하는 사람이 지나는 순서다. 네 장을 관통하는 문장은 하나다. 좋은 논문을 쓰는 능력은 중요한 질문을 알아보고, 결정적인 근거를 설계하고, 다른 사람과 판단을 맞추며, 그 판단의 책임을 지는 능력에서 시작한다. 영어 문장을 다듬는 기술은 그 능력이 자리를 잡은 뒤에 얹힌다. 네 장에서 만든 산출물도 서로 이어져 있어서, field map이 서론의 재료가 되고 method page가 한계 서술의 재료가 되며 결정 기록이 결론 강도의 근거가 된다. 하나만 만들어 두면 나머지 셋이 비어 있는 자리를 그대로 드러낸다. 파트 2를 지나는 동안 다룬 논문은 파트 1에서 따라온 여섯 편에 10장의 벤치마킹 논문 한 편을 더한 것이고, 그 밖에 새로 들인 논문은 없다.
